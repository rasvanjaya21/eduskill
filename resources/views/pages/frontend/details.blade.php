...
<body class=" font-gilroy font-medium text-gray text-lg leading-[27px]">
    ...
    <div class="nav-tab-wrapper tabs  section-padding">
        <div class="container">
            <img src="/frontend/images/all-img/main-event.png" alt="" class=" lg:mb-10 mb-6 block w-full">
            <div class="grid grid-cols-12 gap-[30px]">
                <div class="lg:col-span-8 col-span-12">
                    ...
                    <div class=" py-6">
                        ...
                        ultimately leading to slower execution times; and the fact that it is dynamically typed. Take,
                        for example, TensorFlow,
                        a Machine Learning library available in Python. These libraries were actually written in C++ and
                        made available in
                        Python, sort of forming a Python implementation. The same goes for Numpy and, to an extent, even
                        Caer.
                    </div>
                        ...
                        <ul class="flex space-x-3 lg:justify-end items-center  ">
                            <li>
                                <a href="#" class="flex h-8 w-8">
                                    <img src="/frontend/images/icon/fb.svg" alt="">
                                </a>
                            </li>
                            <li>
                                <a href="#" class="flex h-8 w-8">
                                    <img src="/frontend/images/icon/tw.svg" alt="">
                                </a>
                            </li>
                            <li>
                                <a href="#" class="flex h-8 w-8">
                                    <img src="/frontend/images/icon/pn.svg" alt="">
                                </a>
                            </li>
                            <li>
                                <a href="#" class="flex h-8 w-8">
                                    <img src="/frontend/images/icon/ins.svg" alt="">
                                </a>
                            </li>
                        </ul>
                    </div>
                            ...
                            <ul class="list space-y-6  ">
                                ...
                                <li class=" flex space-x-3 ">
                                    <div class="flex-1 space-x-3 flex">
                                        <img src="/frontend/images/svg/circle-clock.svg" alt="" />
                                ...
                                <li class=" flex space-x-3 ">
                                    <div class="flex-1 space-x-3 flex">
                                        <img src="/frontend/images/svg/circle-c.svg" alt="" />
                        ...
                        <div class="wdiget">
                            ...
                            <ul class="list space-y-6">
                                <li class=" flex space-x-4 border-[#ECECEC] ">
                                    <div class="flex-none ">
                                        <div class="h-20 w-20   rounded-full">
                                            <img src="/frontend/images/all-img/rc-1.png" alt=""
                                ...
                                <li class=" flex space-x-4 border-[#ECECEC] ">
                                    <div class="flex-none ">
                                        <div class="h-20 w-20   rounded-full">
                                            <img src="/frontend/images/all-img/rc-2.png" alt=""
                                                class=" w-full h-full object-cover rounded-full">
                                        </div>
                                    </div>
                                    <div class="flex-1 ">
